...
public class Geometry {
    ...
    public static Rectangle2D getViewPortBounds(
        ...
        double viewportHeight = betterScrollPane
            .getViewportBounds()
            .getHeight();

        // Scale the content dimensions by the zoom factor
        double contentWidth =
            betterScrollPane.getContent().getBoundsInLocal().getWidth() *
            zoomFactor;
        double contentHeight =
            betterScrollPane.getContent().getBoundsInLocal().getHeight() *
            zoomFactor;
    ...
    public static Rectangle2D scaleRectangle(
