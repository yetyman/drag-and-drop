...
public class Grid extends Pane {
    ...
    private void handleDragDropped(DragEvent dragEvent) {
        ...
        if (db.hasContent(DataFormat.PLAIN_TEXT)) {
            ...
            Block newBlock = BlockManager.getInstance().createBlockByName(clipboardContent);
    ...
    public void drawMouseLocation(MouseEvent e) {
        ...
        gc.setStroke(Color.RED);
        gc.setLineWidth(1.5);
        gc.strokeRect(e.getX() - squareSize / 2, e.getY() - squareSize / 2, squareSize, squareSize);
    }
    ...
    public ArrayList<Rectangle2D> getTriggers(MouseEvent e) {
        ...
        triggers.add(new Rectangle2D(viewportBounds.getMinX(), viewportBounds.getMinY(), triggerWidth, viewportBounds.getHeight()));
        triggers.add(new Rectangle2D(viewportBounds.getMaxX() - triggerWidth, viewportBounds.getMinY(), triggerWidth, viewportBounds.getHeight()));
        triggers.add(new Rectangle2D(viewportBounds.getMinX(), viewportBounds.getMinY(), viewportBounds.getWidth(), triggerWidth));
        triggers.add(new Rectangle2D(viewportBounds.getMinX(), viewportBounds.getMaxY() - triggerWidth, viewportBounds.getWidth(), triggerWidth));
    ...
    public Rectangle2D getLeftTrigger(MouseEvent e) {
        double triggerWidth = 20;
        Rectangle2D viewportBounds = App.getViewportBounds();
        return new Rectangle2D(viewportBounds.getMinX(), viewportBounds.getMinY(), triggerWidth, viewportBounds.getHeight());
    }

    public Rectangle2D getRightTrigger(MouseEvent e) {
        double triggerWidth = 20;
        Rectangle2D viewportBounds = App.getViewportBounds();
        return new Rectangle2D(viewportBounds.getMaxX() - triggerWidth, viewportBounds.getMinY(), triggerWidth, viewportBounds.getHeight());
    }

    public Rectangle2D getTopTrigger(MouseEvent e) {
        double triggerWidth = 20;
        Rectangle2D viewportBounds = App.getViewportBounds();
        return new Rectangle2D(viewportBounds.getMinX(), viewportBounds.getMinY(), viewportBounds.getWidth(), triggerWidth);
    }

    public Rectangle2D getBottomTrigger(MouseEvent e) {
        double triggerWidth = 20;
        Rectangle2D viewportBounds = App.getViewportBounds();
        return new Rectangle2D(viewportBounds.getMinX(), viewportBounds.getMaxY() - triggerWidth, viewportBounds.getWidth(), triggerWidth);
    }
    ...
    public void drawTriggers(MouseEvent e) {
        ...
        // Left trigger
        gc.strokeRect(viewportBounds.getMinX(), viewportBounds.getMinY(), triggerWidth, viewportBounds.getHeight());

        // Right trigger
        gc.strokeRect(viewportBounds.getMaxX() - triggerWidth, viewportBounds.getMinY(), triggerWidth, viewportBounds.getHeight());

        // Top trigger
        gc.strokeRect(viewportBounds.getMinX(), viewportBounds.getMinY(), viewportBounds.getWidth(), triggerWidth);

        // Bottom trigger
        gc.strokeRect(viewportBounds.getMinX(), viewportBounds.getMaxY() - triggerWidth, viewportBounds.getWidth(), triggerWidth);
    }
}
